...
class MainPage(BasePage):
    ...
    @allure.step('Кликнуть на кнопку "Оформить заказ" на главной')
    def click_on_button_make_order_in_main(self):
        self.click_on_element(MainPageLocators.button_make_the_order)
    ...
    def create_order_in_main(self):
        ...
        self.wait_invisibility_element(MainPageLocators.loader_overlay)
